    ...
    <div className="space-y-6 text-left animate-fade-slide-up">
      <div className="border-b border-[#EAECF0] pb-4">
        <h1 className="text-2xl font-bold text-[#101828]">
          Administrative Overrides Ledger
        </h1>
        <p className="mt-1 text-xs text-[#475467]">
          Statutory register of all high-risk and flagged conveyances approved via written registrar administrative override.
        </p>
      </div>
            ...
            {overrides.map((ov, idx) => (
              <div key={idx} className="py-3 space-y-1 text-xs">
                <div className="flex items-center justify-between">
                  <span className="font-mono font-bold text-[#0B3A67]">{ov.action}</span>
